...
public class TerrainLeaveEvent extends Event implements ITerrainLeaveEvent<Location, Player>, Cancellable {
    ...
    public TerrainLeaveEvent(@NotNull Location from, @NotNull Location to, @NotNull Player player, @NotNull Terrain terrain, @NotNull EnterLeaveReason reason, boolean cancelled) {
        this.from = from;
        this.to = to;
        this.player = player;
