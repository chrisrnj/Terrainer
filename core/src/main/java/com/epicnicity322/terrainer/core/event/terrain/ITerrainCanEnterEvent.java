...
/**
 * An event used to determine whether a player is allowed to enter terrains.
 *
 * @param <L> The location class of the platform.
 * @param <P> The player class of the platform.
 */
public interface ITerrainCanEnterEvent<L, P> extends TerrainEnterLeaveEvent<L>, PlayerEvent<P> {
}
