...
/**
 * An event used to determine whether a player is allowed to leave terrains.
 *
 * @param <L> The location class of the platform.
 * @param <P> The player class of the platform.
 */
public interface ITerrainCanLeaveEvent<L, P> extends TerrainEnterLeaveEvent<L>, PlayerEvent<P> {
}
