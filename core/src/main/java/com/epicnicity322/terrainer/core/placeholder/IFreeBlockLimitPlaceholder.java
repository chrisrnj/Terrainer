...
public interface IFreeBlockLimitPlaceholder<O, P extends O> extends PlaceholderFormatter<O, P> {
    @Override
    ...
    default String formatOnlinePlaceholder(@Nullable P player, @NotNull String params) {
        ...
        return Long.toString(playerUtil.getMaxBlockLimit(player) - playerUtil.getUsedBlockLimit(playerUtil.getUniqueId(player)));
    }
}
