...
public interface ITerrainCreationDatePlaceholder<O, P extends O> extends TerrainPlaceholderFormatter<O, P> {
    @Override
    default @NotNull String name() {
        return "terrain-creation-date";
    }
    ...
    default String formatPlaceholder(@Nullable O player, @NotNull String params, @Nullable Terrain terrain) {
        ...
        return terrain.creationDate().format(DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss"));
    }
}
