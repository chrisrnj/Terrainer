...
public interface ITerrainNamePlaceholder<O, P extends O> extends TerrainPlaceholderFormatter<O, P> {
    @Override
    ...
    default String formatPlaceholder(@Nullable O player, @NotNull String params, @Nullable Terrain terrain) {
        if (terrain == null) return Terrainer.lang().get("Placeholder Values.Terrain Not Found");
        return terrain.name();
    }
}
