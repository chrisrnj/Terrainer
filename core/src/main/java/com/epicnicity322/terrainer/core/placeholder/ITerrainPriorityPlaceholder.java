...
public interface ITerrainPriorityPlaceholder<O, P extends O> extends TerrainPlaceholderFormatter<O, P> {
    @Override
    default @NotNull String name() {
        return "terrain-priority";
    }
    ...
    default String formatPlaceholder(@Nullable O player, @NotNull String params, @Nullable Terrain terrain) {
        ...
        return Integer.toString(terrain.priority());
    }
}
